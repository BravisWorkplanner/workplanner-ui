...
namespace APIClient.Model
{
    ...
    public partial class OrderCreateRequest : IEquatable<OrderCreateRequest>, IValidatableObject
    {
        ...
        public OrderCreateRequest(string objectNumber = default(string), string description = default(string), string address = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), DateTime? invoiceDate = default(DateTime?), OrderStatus? orderStatus = default(OrderStatus?))
        {
