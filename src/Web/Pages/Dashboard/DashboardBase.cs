...
public class DashboardBase : ComponentBase
{
    ...
    {
        var orders = await APIClient.HandleHttpCallAsync(() => APIClient.Order_ListAsync(1000, 0), Logger);
        var workers = await APIClient.HandleHttpCallAsync(() => APIClient.Worker_ListAsync(1000, 0), Logger);
    ...
    protected double CalculateTotalPriceForOrder()
    {
        return Math.Round((random.NextDouble() * (5000 - 250)) + 250, 2);
    }
